...
class Bookmarks extends Component {
    ...
    render() {
        ...
        return (
            <NavigationBar title={window.getLanguageFile().internalPages.bookmarks.title} buttons={[
                <Button color="inherit" onClick={this.handleDialogOpen.bind(this, 'create')}>フォルダを追加</Button>,
                <Button color="inherit" onClick={this.handleDialogOpen.bind(this, 'clear')}>{window.getLanguageFile().internalPages.bookmarks.clear}</Button>
            ]}>
                            ...
                            <Grid item xs={12} className={classes.panelRoot}>
                                {this.props.match.params.id &&
                                    <Paper elevation={0} variant="outlined" style={{ padding: 10, marginBottom: 10 }}>
                                        <Breadcrumbs aria-label="breadcrumb">
                                            <Link to="/" color="inherit" component={RouterLink}>{window.getLanguageFile().internalPages.bookmarks.title}</Link>
                                ...
                                <Paper>
                                    <Table className={classes.table}>
                                        <TableBody>
                                            {this.state.bookMarks.map((item, v) => {
                                                return (
                                                    <TableRow key={v}>
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button color="primary" variant="contained" onClick={() => { window.addBookmark(this.state.createFolderName, '', true, false); this.setState({ createFolderName: '' }); }}>
                            登録
                        </Button>
                    </DialogActions>
                </Dialog>
