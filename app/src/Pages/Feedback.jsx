...
class Feedback extends Component {
    ...
    handleSendClick = () => {
        fetch('https://s.0u0.biz/hooks/iotqrb6u83f8ukgptdarsujwbo', {
            mode: 'no-cors',
            method: 'POST',
            headers: {
                ...
                attachments: [
                    {
                        ...
                        fields: [
                            ...
                            },
                            {
                                short: false,
                                title: 'システム情報',
                                value: `OS: \`${window.getOSVersion()}\`, Flast_Version: \`${window.getAppVersion()}\` (\`${window.getAppChannel()}\`), Electron_Version: \`${window.getElectronVersion()}\`, Chromium_Version: \`${window.getChromiumVersion()}\``
                            }
                        ]
                    }
                ]
